cd 'F:\final year project\HVsundar_dataset\RIR-Generator-master'
mex -setup C++
...
Fs = 16000;
[y, Fs] = audioread('C:\Users\Niraj\Desktop\finl project\SELD\timit\data\TEST\DR8\FCMH1\SA1.wav');
x01= fftfilt(h0(1,:),y);
x02= fftfilt(h0(2,:),y);
x03= fftfilt(h0(3,:),y);
x04= fftfilt(h0(4,:),y);
...
y1cor=[];
for i=1:8
    x1cor(i)=a.ref_pts(i,1);
    y1cor(i)=a.ref_pts(i,2);
end
